 ...
 */
public class manEmpleados extends JPanel {
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                manEmpleados.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                manEmpleados.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                manEmpleados.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                manEmpleados.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<venta.de.medicamentos.Empleado> toRemove = new ArrayList<venta.de.medicamentos.Empleado>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            venta.de.medicamentos.Empleado e = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(e);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        venta.de.medicamentos.Empleado e = new venta.de.medicamentos.Empleado();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<venta.de.medicamentos.Empleado> merged = new ArrayList<venta.de.medicamentos.Empleado>(list.size());
            for (venta.de.medicamentos.Empleado e : list) {
    ...
    private java.util.List<venta.de.medicamentos.Empleado> list;
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new manEmpleados());
