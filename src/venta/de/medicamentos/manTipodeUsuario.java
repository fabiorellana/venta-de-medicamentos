 ...
 */
public class manTipodeUsuario extends JPanel {
    
    public manTipodeUsuario() {
        initComponents();
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT t FROM TipoUsuario t");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                manTipodeUsuario.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                manTipodeUsuario.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                manTipodeUsuario.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                manTipodeUsuario.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<venta.de.medicamentos.TipoUsuario> toRemove = new ArrayList<venta.de.medicamentos.TipoUsuario>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            venta.de.medicamentos.TipoUsuario t = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(t);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        venta.de.medicamentos.TipoUsuario t = new venta.de.medicamentos.TipoUsuario();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<venta.de.medicamentos.TipoUsuario> merged = new ArrayList<venta.de.medicamentos.TipoUsuario>(list.size());
            for (venta.de.medicamentos.TipoUsuario t : list) {
    ...
    private java.util.List<venta.de.medicamentos.TipoUsuario> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(manTipodeUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new manTipodeUsuario());
