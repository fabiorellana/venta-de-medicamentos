 ...
 */
public class BuscarSexo extends javax.swing.JInternalFrame {

    /**
     * Creates new form BuscarSexo
     */
    public BuscarSexo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btBuscarr = new javax.swing.JButton();
        jScrollPane1 = new javax.swing.JScrollPane();
        jtTabla = new javax.swing.JTable();

        setClosable(true);
        setTitle("Buscar Sexo");

        dp.setBackground(new java.awt.Color(153, 153, 153));

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setText("Buscar Sexo");

        btBuscarr.setText("Buscar");
        btBuscarr.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btBuscarrActionPerformed(evt);
            }
        });
        ...
        dp.setLayer(btBuscarr, javax.swing.JLayeredPane.DEFAULT_LAYER);
    ...
    private void btBuscarrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btBuscarrActionPerformed
        // TODO add your handling code here:
        
        String b = tfBuscar.getText();
        String sql = "SELECT * FROM sexo WHERE codigo ='"+ b +"'";
    ...
    }//GEN-LAST:event_btBuscarrActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btBuscarr;
