 ...
 */
public class manReceta extends JPanel {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT r FROM Receta r");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                manReceta.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                manReceta.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                manReceta.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                manReceta.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<venta.de.medicamentos.Receta> toRemove = new ArrayList<venta.de.medicamentos.Receta>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            venta.de.medicamentos.Receta r = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(r);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        venta.de.medicamentos.Receta r = new venta.de.medicamentos.Receta();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<venta.de.medicamentos.Receta> merged = new ArrayList<venta.de.medicamentos.Receta>(list.size());
            for (venta.de.medicamentos.Receta r : list) {
    ...
    private java.util.List<venta.de.medicamentos.Receta> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(manReceta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new manReceta());
