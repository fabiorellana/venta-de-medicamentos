 ...
 */
public class manLaboratorio extends JPanel {
    
    public manLaboratorio() {
        initComponents();
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT l FROM Laboratorio l");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                manLaboratorio.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                manLaboratorio.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                manLaboratorio.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                manLaboratorio.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<venta.de.medicamentos.Laboratorio> toRemove = new ArrayList<venta.de.medicamentos.Laboratorio>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            venta.de.medicamentos.Laboratorio l = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(l);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        venta.de.medicamentos.Laboratorio l = new venta.de.medicamentos.Laboratorio();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<venta.de.medicamentos.Laboratorio> merged = new ArrayList<venta.de.medicamentos.Laboratorio>(list.size());
            for (venta.de.medicamentos.Laboratorio l : list) {
    ...
    private java.util.List<venta.de.medicamentos.Laboratorio> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(manLaboratorio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new manLaboratorio());
