 ...
 */
public class manValorUnidad extends JPanel {
    
    public manValorUnidad() {
        initComponents();
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT v FROM ValorUnitario v");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                manValorUnidad.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                manValorUnidad.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                manValorUnidad.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                manValorUnidad.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<venta.de.medicamentos.ValorUnitario> toRemove = new ArrayList<venta.de.medicamentos.ValorUnitario>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            venta.de.medicamentos.ValorUnitario v = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(v);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        venta.de.medicamentos.ValorUnitario v = new venta.de.medicamentos.ValorUnitario();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<venta.de.medicamentos.ValorUnitario> merged = new ArrayList<venta.de.medicamentos.ValorUnitario>(list.size());
            for (venta.de.medicamentos.ValorUnitario v : list) {
    ...
    private java.util.List<venta.de.medicamentos.ValorUnitario> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(manValorUnidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new manValorUnidad());
