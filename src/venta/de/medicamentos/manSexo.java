 ...
 */
public class manSexo extends JPanel {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT s FROM Sexo s");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                manSexo.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                manSexo.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                manSexo.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                manSexo.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<venta.de.medicamentos.Sexo> toRemove = new ArrayList<venta.de.medicamentos.Sexo>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            venta.de.medicamentos.Sexo s = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(s);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        venta.de.medicamentos.Sexo s = new venta.de.medicamentos.Sexo();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<venta.de.medicamentos.Sexo> merged = new ArrayList<venta.de.medicamentos.Sexo>(list.size());
            for (venta.de.medicamentos.Sexo s : list) {
    ...
    private java.util.List<venta.de.medicamentos.Sexo> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(manSexo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new manSexo());
